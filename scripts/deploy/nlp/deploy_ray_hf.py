...
def parse_args():
    ...
    parser.add_argument(
        "--task", type=str, default="text-generation", help="HuggingFace task type (e.g., 'text-generation')"
    )
    parser.add_argument(
    ...
    parser.add_argument("--num_gpus", type=int, default=1, help="Number of GPUs to allocate for the Ray cluster")
    parser.add_argument("--include_dashboard", action="store_true", help="Whether to include the Ray dashboard")
    parser.add_argument("--num_replicas", type=int, default=1, help="Number of model replicas to deploy")
    parser.add_argument("--num_gpus_per_replica", type=float, default=1, help="Number of GPUs per model replica")
...
def main():
    ...
    try:
        ...
        app = HFRayDeployable.options(
            ...
            ray_actor_options={"num_gpus": args.num_gpus_per_replica, "num_cpus": args.num_cpus_per_replica},
        ).bind(
