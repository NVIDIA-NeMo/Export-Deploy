...
def get_args(argv):
    ...
    parser.add_argument(
        "-ucr", "--use_cpp_runtime", default=False, action="store_true", help="Use TensorRT LLM C++ runtime"
    )
    parser.add_argument(
        "-b",
        "--backend",
    ...
    parser.add_argument(
        "-srs", "--start_rest_service", default=False, type=bool, help="Starts the REST service for OpenAI API support"
    )
    parser.add_argument(
