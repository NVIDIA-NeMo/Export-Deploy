...
def get_args(argv):
    ...
    parser.add_argument(
        "-fd", "--enable_flash_decode", default=False, action="store_true", help="Enable flash decoding"
    )
    parser.add_argument("-cg", "--enable_cuda_graphs", default=False, action="store_true", help="Enable CUDA graphs")
