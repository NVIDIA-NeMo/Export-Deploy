...
warnings.warn(
    "The 'nemo_deploy.nlp.inference' module is deprecated and will be renamed to 'nemo_deploy.llm.inference' in the next release. "
    "To ensure compatibility with future versions, please change your imports from 'nemo_deploy.nlp.inference' to 'nemo_deploy.llm.inference' as soon as possible.",
    DeprecationWarning,
    stacklevel=2,
)
