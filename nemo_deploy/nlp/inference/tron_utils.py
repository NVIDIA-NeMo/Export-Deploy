    ...
    if (
        ...
        for i in range(parallel_state.get_virtual_pipeline_model_parallel_world_size()):
            ...
            this_model = model_config.configure_model(
                tokenizer=None, pre_process=pre_process, post_process=post_process
            )
        ...
        if model_type == ModelType.encoder_and_decoder:
            ...
            model = model_config.configure_model(tokenizer=None)
        else:
            model = model_config.configure_model(tokenizer=None, pre_process=pre_process, post_process=post_process)
