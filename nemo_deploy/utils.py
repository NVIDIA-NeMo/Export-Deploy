...
def typedict2tensor(
    typedict_class,
    overwrite_kwargs: typing.Optional[
        typing.Dict[
            str,
            typing.Any,
        ]
    ] = None,
    defaults: typing.Optional[
        typing.Dict[
            str,
            typing.Any,
        ]
...
def str_ndarray2list(
    str_ndarray: np.ndarray,
) -> typing.List[str]:
