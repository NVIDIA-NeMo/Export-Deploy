...
from nemo_export_deploy.deploy.deploy_ray import DeployRay, use_ray


class TestDeployRay(unittest.TestCase):

    @patch('nemo_export_deploy.deploy.deploy_ray.ray')
    ...
    @patch('nemo_export_deploy.deploy.deploy_ray.use_ray', False)
    ...
    @patch('nemo_export_deploy.deploy.deploy_ray.ray')
    @patch('nemo_export_deploy.deploy.deploy_ray.serve')
    ...
    @patch('nemo_export_deploy.deploy.deploy_ray.ray')
    @patch('nemo_export_deploy.deploy.deploy_ray.serve')
    @patch('nemo_export_deploy.deploy.deploy_ray.find_available_port')
    ...
    @patch('nemo_export_deploy.deploy.deploy_ray.ray')
    @patch('nemo_export_deploy.deploy.deploy_ray.serve')
    @patch('nemo_export_deploy.deploy.deploy_ray.LOGGER')
