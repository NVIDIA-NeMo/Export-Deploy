...
class TestTensorRTMMExporter:
    ...
    @pytest.mark.run_only_on("GPU")
    def test_init_invalid_modality(
        self,
        model_dir,
    ):
    ...
    @pytest.mark.run_only_on("GPU")
    def test_forward_without_loading(
        self,
        model_dir,
    ):
        from nemo_export.tensorrt_mm_exporter import (
    ...
    @pytest.mark.run_only_on("GPU")
    def test_forward_with_all_params(
        self,
        model_dir,
        mock_runner,
    ):
    ...
    @pytest.mark.run_only_on("GPU")
    def test_get_input_media_tensors_vision(
        self,
        model_dir,
    ):
        from nemo_export.tensorrt_mm_exporter import (
    ...
    @pytest.mark.run_only_on("GPU")
    def test_export_with_invalid_model_type(
        self,
        model_dir,
    ):
        from nemo_export.tensorrt_mm_exporter import (
    ...
    @pytest.mark.run_only_on("GPU")
    def test_export_with_existing_files(
        self,
        model_dir,
    ):
        import os
