...
from nemo_export_deploy.deploy.nlp.query_llm import NemoQueryLLM, NemoQueryLLMBase, NemoQueryLLMHF, NemoQueryLLMPyTorch
...
class TestNemoQueryLLMPyTorch:
    ...
    @patch('nemo_export_deploy.deploy.nlp.query_llm.ModelClient')
...
class TestNemoQueryLLM:
    ...
    @patch('nemo_export_deploy.deploy.nlp.query_llm.DecoupledModelClient')
