...
class TestNemoQueryLLMPyTorch:
    ...
    @patch("nemo_deploy.nlp.query_llm.ModelClient")
    def test_query_llm_with_logprobs(
        self,
        mock_client,
        query,
    ):
...
class TestNemoQueryLLMHF:
    ...
    @patch("nemo_deploy.nlp.query_llm.ModelClient")
    def test_query_llm_with_logits(
        self,
        mock_client,
        query,
    ):
...
class TestNemoQueryLLM:
    ...
    @patch("nemo_deploy.nlp.query_llm.ModelClient")
    def test_query_llm_openai_format(
        self,
        mock_client,
        query,
    ):
    ...
    @patch("nemo_deploy.nlp.query_llm.ModelClient")
    def test_query_llm_with_stop_words(
        self,
        mock_client,
        query,
    ):
    ...
    @patch("nemo_deploy.nlp.query_llm.ModelClient")
    def test_query_llm_with_bad_words(
        self,
        mock_client,
        query,
    ):
