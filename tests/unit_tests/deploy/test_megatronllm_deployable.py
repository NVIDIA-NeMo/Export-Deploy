...
@pytest.mark.run_only_on("GPU")
def test_generate_without_cuda_graphs(
    deployable,
):
...
@pytest.mark.run_only_on("GPU")
def test_generate_with_cuda_graphs(
    deployable,
):
...
def test_apply_chat_template(
    ...
    with patch(
        "nemo_deploy.nlp.megatronllm_deployable.Template",
...
def test_infer_fn_basic(
    ...
    with (
        ...
        mock_result1 = MagicMock()
        mock_result1.generated_text = "Generated text 1"
        mock_result1.generated_log_probs = [
            0.1,
            0.2,
            0.3,
        ]
        ...
        mock_result2 = MagicMock()
        mock_result2.generated_text = "Generated text 2"
        mock_result2.generated_log_probs = [
            0.4,
            0.5,
        ]
...
@pytest.mark.run_only_on("GPU")
def test_infer_fn_with_log_probs(
    deployable,
):
...
@pytest.mark.run_only_on("GPU")
def test_infer_fn_with_chat_template(
    deployable,
):
...
@pytest.mark.run_only_on("GPU")
def test_infer_fn_with_distributed(
    deployable,
):
...
@pytest.mark.run_only_on("GPU")
def test_infer_fn_empty_log_probs(
    deployable,
):
...
@pytest.mark.run_only_on("GPU")
def test_ray_infer_fn_with_defaults(
    deployable,
):
...
@pytest.mark.run_only_on("GPU")
def test_ray_infer_fn_with_log_probs(
    deployable,
):
...
@pytest.mark.run_only_on("GPU")
def test_ray_infer_fn_with_chat_template(
    deployable,
):
