...
def test_determine_quantization_settings():
    ...
    from nemo_export_deploy.export.trt_llm.converter.model_converter import determine_quantization_settings
...
def test_prompt_convert_task_templates():
    ...
    from nemo_export_deploy.export.trt_llm.converter.model_converter import prompt_convert
